...
export const DriverLocationService = LocationService.getInstance('driver', DRIVER_CONFIG);
export const PassengerLocationService = LocationService.getInstance('passenger', PASSENGER_CONFIG);
